...
export type DataTableProps<T extends DataTableRowData = any> = ExtractPublicPropTypes<ReturnType<typeof _propsMakeGeneric<T>>>;
export type DataTableInstance = NDataTableInst & {
  $forwardComponent: NDataTableInst;
};

function convertVNodesToColumns<T extends NDataTableRowData>(vnodes: VNode[], depth: number = 1): NDataTableColumn<T>[] {
  ...
  vnodes.forEach((vnode, index) => {
    ...
    if (vnode.type === ComponentDataTableColumn) {
      ...
      logger.warning('Each child component in {0} should be {1}.', ComponentDataTable.name, ComponentDataTableColumn.name);
    }
  });
...
function convertVNodesToSummaryRows<T extends NDataTableRowData>(vnodes: VNode[], options: { pageData: T[] }): NDataTableSummaryRow[] {
  ...
  vnodes.forEach((vnode) => {
    ...
    if (vnode.type === ComponentDataTableSummaryRow) {
      ...
      logger.warning('Each child component in `summary` slot of {0} should be {1}.', ComponentDataTable.name, ComponentDataTableSummaryRow.name);
    }
  });
  ...
  vnodes.forEach((vnode) => {
    ...
    if (vnode.type === ComponentDataTableSummaryCell) {
      if (__DEV__ && vKey == null) {
        logger.warning('Each {0} should have a `key` prop related to a column.', ComponentDataTableSummaryCell.name);
      }
      ...
      logger.warning('Each child component in {0} should be {1}.', ComponentDataTableSummaryRow.name, ComponentDataTableSummaryCell.name);
    }
  });
...
function populateColumnRenders<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false): NDataTableColumn<T> {
...
function resolveColumnRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveCellRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveExpandRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveFilterRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveFilterIconRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveFilterMenuRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveSorterRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
...
function resolveSorterIconRender<T extends NDataTableRowData>(column: NDataTableColumn<T>, ctxSlots: Slots, ctxSingle = false) {
