        ...
        <n-space vertical :size="20">
            ...
            >
                <template #content>
                    <p>
                        同 Naive-UI 官方文档示例「
                        <n-a href="//www.naiveui.com/zh-CN/os-theme/components/button#basic.vue" target="blank">
                            Button - 基础用法
                        </n-a>
                        」。
                    </p>
            ...
            <DemoCard
                title="Size / 尺寸"
                anchor="size"
                :js-code="$encode(SampleSizeCodeJs)"
                :ts-code="$encode(SampleSizeCodeTs)"
            >
                <template #content>
                    <p>
                        同 Naive-UI 官方文档示例「
                        <n-a href="//www.naiveui.com/zh-CN/os-theme/components/button#size.vue" target="blank">
                            Button - 尺寸
                        </n-a>
                        」。
                    </p>
            ...
            <DemoCard
                title="Shape / 形状"
                anchor="size"
                :js-code="$encode(SampleShapeCodeJs)"
                :ts-code="$encode(SampleShapeCodeTs)"
            >
                <template #content>
                    <p>
                        同 Naive-UI 官方文档示例「
                        <n-a href="//www.naiveui.com/zh-CN/os-theme/components/button#shape.vue" target="blank">
                            Button - 形状
                        </n-a>
                        」。
                    </p>
