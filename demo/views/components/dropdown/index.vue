    ...
    >
        <n-space vertical :size="20">
            ...
            >
                <template #content>
                    <p>
                        ...
                        <n-a href="//www.naiveui.com/zh-CN/os-theme/components/dropdown#basic.vue" target="blank">
                            Dropdown - 基础用法
                        </n-a>
                        」。
                    </p>
            ...
            <DemoCard
                title="Icon / 图标"
                anchor="icon"
                :js-code="$encode(SampleIconCodeJs)"
                :ts-code="$encode(SampleIconCodeTs)"
            >
                <template #content>
                    <p>
                        以模板形式改写 Naive-UI 官方文档示例「
                        <n-a href="//www.naiveui.com/zh-CN/os-theme/components/dropdown#icon.vue" target="blank">
                            Dropdown - 图标
                        </n-a>
                        」。
                    </p>
